...
SECRET_KEY = '4@ck%$k$q!j$r*_jd&&j*19yfzrq!aw0tk8qj&@h3i))hsn+$q'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.dirname('__file__'),os.path.join(BASE_DIR, 'Retirement_Planner/'),
                 os.path.join(BASE_DIR, 'static/'),
                 os.path.join(BASE_DIR, 'static/dashboard_template')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
